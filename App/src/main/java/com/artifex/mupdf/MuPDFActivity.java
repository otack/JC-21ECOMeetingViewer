...
public class MuPDFActivity extends Activity
{
	...
	enum TopBarMode {Main, Search, Annot, Delete, Accept};
    ...
    // added buttons for fragment
    private ImageButton mCancelSearch;
    private ImageButton mCancelAnnot;
    private ImageButton mHighlightButton;
    private ImageButton mUnderline;
    private ImageButton mStrikeOut;
    private ImageButton mInk;
    private ImageButton mCancelDelete;
    private ImageButton mDelete;
    private ImageButton mCopyText;
	...
	private MuPDFCore openFile(String path)
	{
        ...
        mFileTitle = intent.getStringExtra("fileTitle");
	...
	public void createUI(Bundle savedInstanceState) {
		...
		mFilenameView.setText(mFileTitle);
        ...
        mCancelSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OnCancelSearchButtonClick(v);
            }
        });

        mCancelAnnot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OnCancelAnnotButtonClick(v);
            }
        });
        ...
        mUnderline.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mStrikeOut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mInk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OnInkButtonClick(v);
            }
        ...
        mCancelAccept.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
		...
		SharedPreferences prefs = getSharedPreferences("pdf_state", Context.MODE_PRIVATE);
		mDocView.setDisplayedViewIndex(prefs.getInt("page_"+mFileName, 0));
	...
	private void reflowModeSet(boolean reflow)
	{
        ...
        setButtonEnabled(mCopyText, !reflow);
	...
	protected void onSaveInstanceState(Bundle outState) {
		...
		if (mFileName != null && mDocView != null) {
            ...
            outState.putString("FileTitle", mFileTitle);
			...
			edit.putInt("page_"+mFileName, mDocView.getDisplayedViewIndex());
			edit.commit();
		}
	...
	private void setLinkHighlight(boolean highlight) {
        ...
        showInfo(mLinkHighlight ? getString(R.string.entering_link_mode) : getString(R.string.leaving_link_mode));
	}
	...
	private void makeButtonsView() {
        ...
        // added buttons for fragment
        mCancelSearch = (ImageButton)mButtonsView.findViewById(R.id.cancelSearch);
        mCancelAnnot = (ImageButton)mButtonsView.findViewById(R.id.cancelAnnotButton);
        mHighlightButton = (ImageButton)mButtonsView.findViewById(R.id.highlightButton);
        mUnderline = (ImageButton)mButtonsView.findViewById(R.id.underlineButton);
        mStrikeOut = (ImageButton)mButtonsView.findViewById(R.id.strikeOutButton);
        mInk = (ImageButton)mButtonsView.findViewById(R.id.inkButton);
        mCancelDelete = (ImageButton)mButtonsView.findViewById(R.id.cancelDeleteButton);
        mDelete = (ImageButton)mButtonsView.findViewById(R.id.deleteButton);
        mCopyText = (ImageButton)mButtonsView.findViewById(R.id.copyTextButton);
        mCancelAccept = (ImageButton)mButtonsView.findViewById(R.id.cancelAcceptButton);
        mAccept = (ImageButton)mButtonsView.findViewById(R.id.acceptButton);
	}
