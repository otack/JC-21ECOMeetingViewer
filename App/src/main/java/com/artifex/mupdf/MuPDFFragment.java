...
//
//import in.slit.hotori.MainActivity;
...
//    private ImageButton mCancelMore;
...
//        });
//
//        mCancelMore.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                OnCancelMoreButtonClick(v);
//            }
//        });
//
...
//
//        Bundle bundle = getArguments();
//        Uri docUri = bundle != null ? Uri.parse(bundle.getString("uri")) : null;
//
//        if (docUri == null) {
//            showInfo(getString(R.string.print_failed));
//        }
...
//        mCancelMore = (ImageButton)mButtonsView.findViewById(R.id.cancelMoreButton);
//        mPrint = (ImageButton)mButtonsView.findViewById(R.id.printButton);
...
////            searchModeOn();
////        }
////        return super.getActivity().onSearchRequested();
////    }
//
//    @Override
